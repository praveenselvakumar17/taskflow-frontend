...
import { BACK_BUTTON, DANGER_BTN, FULL_BUTTON, INPUT_WRAPPER, SECTION_WRAPPER, securityFields } from '../assets/dummy'
...
const Profile = ({ setCurrentUser, onLogout }) => {
  ...
  const personalFields = [
    { name: "name", type: "text", placeholder: "Enter name", icon: UserCircle },
    { name: "email", type: "email", placeholder: "Enter email", icon: UserCircle },
  ];
